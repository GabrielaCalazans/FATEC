...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/05/22 19:58:28 by gacalaza          #+#    #+#              #
#    Updated: 2024/05/22 20:02:17 by gacalaza         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #


# A2) Utilize uma lista para resolver o problema a seguir. Uma empresa paga seus
# vendedores com base em comissões. O vendedor recebe $200 por semana mais 9
# por cento de suas vendas brutas daquela semana. Por exemplo, um vendedor
