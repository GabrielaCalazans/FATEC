...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/10/15 15:10:56 by gacalaza          #+#    #+#              #
#    Updated: 2024/10/15 15:10:56 by gacalaza         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# **********  Ex. 01 **********
# 01 – Escreva um programa que pergunte a velocidade do carro de um usuário. 
...
def	ex01():
	...
	if (n1 > 80):
		print(f"You got a traffic ticket - value: R${(n1 - 80)*105}")
	else:
		print("OK. Safe travel.")


# *****************  Ex. 02 *********************
# 02 – Escreva um programa que leia três números e que imprima o maior e o menor. 
def	ex02():
	print("\n****** Exercise 02 ******\n")
...
# *****************  Ex. 03 *********************
# 03 – Escreve um programa que pergunte o salário do funcionário e calcule o 
...
# *****************  Ex. 04 *********************
# 04 – Execute o programa no qual o usuário entre com a idade do carro e caso o valor 
...
# *****************  Ex. 05 *********************
# 05 – Escreva um programa que pergunte a distância que um passageiro deseja percorrer em km. 
...
# *****************  Ex. 06 *********************
# 06 – Escreva um programa que calcular a categoria de um produto e determine o 
# preço pela tabela: Categoria 1 valor de R$ 10,00; Categoria 2 valor de R$ 15,00; 
# Categoria 3 valor de R$ 19,00; Categoria 4 valor de R$ 23,00 e Categoria 5 valor de R$ 27,00. 
def	ex06():
	print("\n****** Exercise 06 ******\n")
	...
	if cat == 5:
		...
		print("Category no found!")


# *****************  Ex. 07 *********************
# 07 – Escreva um programa que leia dois números e que pergunte qual operação você deseja realizar. 
...
# *****************  Ex. 08 *********************
# 08 – Escreva um programa para aprovar o empréstimo bancário para compra de uma casa. 
...
# *****************  Ex. 09 *********************
# 09 – Escreva um programa que calcule o preço a pagar pelo fornecimento de energia elétrica. 
